...
const EditPhotoPage: NextPage<EditPhotoProps> = ({ accessToken, entry, type, imgRes }) => (
  <>
    <NextSeo title={SEO.editPhoto.title} description={SEO.editPhoto.description} />
    <PhotoLayout>
      <EditPhoto accessToken={accessToken} entry={entry} type={type} imgRes={imgRes} />
    </PhotoLayout>
  </>
);
