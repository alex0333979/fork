...
const commonFaqs: IFAQ[] = [
  ...
  },
  {
    key: 'faq5',
    question:
      'How do I print photos at my local retailer (CVS, Walgreens, etc)?',
    answer: (
      <p>
        <b>Step 1:</b> Open the confirmation email on your PC or Mobile.
        <br />
        <b>Step 2:</b> When you use your mobile device, please make sure to
        press on the link (“Download Your Photos For Print”) and then click
        “Save” your photos to your “photo library”. If you use your PC, “Right
        Click” on the photo link (“Download Your Photos For Print”) placed under
        your “Order items” section and then choose “save link as & save it as a
        .jpeg” image.
        <br />
        ...
        <br />
        https://www.cvs.com/photo/prints (or)
        ...
        <br />
        <b>Step7:</b> Pay online. The photos will be waiting for you at the
        store.
        <br />
  ...
  },
  {
    ...
    answer: (
      <p>
        ...
        under your “Order items” section, then choose “save link as & save it as
        a .jpeg image file
        <br />
        <b>Step3:</b> You are all set - your can now upload your digital
        (single) photo to any official website that has the option to do so.
      </p>
    ),
  },
  {
    ...
    answer: (
      <p>
        ...
        <br />
        <b>Step3:</b> When your use your mobile device, please make sure to
        press on the link (“Download Your Photos For Print”) and then click
        “save” your photos to your “photos library”. If you use your PC, press
        “Right Click” on the photo link (“Download Your Photos For Print”)
        placed under your “Order items” section, then choose “save link as” &
        save it as a .jpeg.
        <br />
...
export const Faqs: Record<string, IFAQ[]> = {
  default: [...commonFaqs],
  'order-passport-photos-online': [...commonFaqs],
  'take-your-own-passport-photo': [...commonFaqs],
  'take-your-passport-photo-with-your-phone': [...commonFaqs],
  'take-passport-photos-at-home': [...commonFaqs],
  'print-passport-photos-at-home': [...commonFaqs],
}
