...
export type CartKeySpecifier = ('billingAddress' | 'coupon' | 'defaultCurrency' | 'expeditingService' | 'items' | 'promoCode' | 'remarks' | 'shippingAddress' | 'shippingType' | CartKeySpecifier)[];
