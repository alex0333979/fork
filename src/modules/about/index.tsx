...
import img3 from '@/assets/images/About/workflow.svg'
import img4 from '@/assets/images/About/multiple_shape.svg'
import img5 from '@/assets/images/About/like.svg'
import img6 from '@/assets/images/About/integrity.svg'
import img7 from '@/assets/images/About/about-3.jpg'
import img8 from '@/assets/images/About/about-4.jpg'
        ...
        <div className="row">
          ...
          <div className="img col-12 col-lg-7">
            <div className="img-wrap">
              <span>
                <Image src={img1} width={370} height={434} alt="" />
              </span>
              <span className="d-none d-md-flex">
                <Image src={img2} width={354} height={455} alt="" />
              </span>
            </div>
          </div>
        </div>
              ...
              <ul>
                <li>
                  ...
                  <p>
                    ...
                    seconds. Sent to you wherever you are. No need to wait for
                    so called “experts” to verify your photo or wait in line at
                    the local drug store
                  </p>
                </li>
                <li>
                  <div className="icon">
                    <Image src={img4} width={40} height={40} alt="" />
                  </div>
                ...
                <li>
                  <div className="icon">
                    <Image src={img5} width={40} height={40} alt="" />
                  </div>
                ...
                <li>
                  <div className="icon">
                    <Image src={img6} width={40} height={40} alt="" />
                  </div>
                  <h4>Integrity</h4>
                  <p>
      ...
      <div className="container">
        <div className="row align-items-lg-center">
          <div className="col-12 col-lg-6">
            <div className="img">
              <Image src={img7} layout="fill" alt="" />
            </div>
          </div>
          <div className="col-12 col-lg-6">
            <div className="text">
    ...
    <div className="about-why">
      <div className="container">
        <div className="row">
          <div className="col-12 col-lg-6">
            <div className="img">
              <Image src={img8} layout="fill" alt="" />
            </div>
          </div>
          <div className="col-12 col-lg-6">
            <div className="text">
