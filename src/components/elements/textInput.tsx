...
import { FormField, ValidationType } from '@/apollo'
...
const TextInput: React.FC<TextInputProps> = ({
  ...
  useEffect(() => {
    const a = formField.validations?.find(
      (v) => v.type === ValidationType.IsNumber,
    )
    const b = formField.validations?.find(
      (v) => v.type === ValidationType.MinLength,
    )
    const c = formField.validations?.find(
      (v) => v.type === ValidationType.MaxLength,
    )
    if (a) {
